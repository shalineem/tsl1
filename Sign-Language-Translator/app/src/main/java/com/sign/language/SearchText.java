    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.search_txt) {
            ...
            for (int i = 0; i < words.length; i++) {
                ...
                * */
                url = new StringBuffer(getString(R.string.IndianSignAlgorithm));
                ...
                try {
                    ...
                    for (int i = str.length() - 1; i >= 0; i--) {
                        ...
                        if (str.charAt(i) <= '9' && str.charAt(i) >= '0')
                            mURLs.add(0, new StringBuffer(getString(R.string.dataset) + str.charAt(i) + ".jpg"));
                        ...
                        /* If the character is an alphabet use "http://www.lifeprint.com/asl101/fingerspelling/abc-gifs/" and add it to the beginning of URLs list */
                            ...
                            mURLs.add(0, new StringBuffer(getString(R.string.dataset1) + str.charAt(i) + "_small.gif"));
                    }
